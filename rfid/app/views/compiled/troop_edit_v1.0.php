...
<body>
<div id="map">
	<span class='title'>井队编辑</span>
</div>
<div id="content">
	<form id="tool" action="/troop/edit" method="post">
	<table class='table table-striped table-bordered'>
		<thead>
		<input name="tid" type='hidden' style='width:150px;height:30px;' value='<?php echo $this->scope["data"]["tid"];?>'/>
			<tr>
				<th width="40%">名称</th>
				<th>值</th>
			</tr>
...
/* -- foreach end output */
			...
			<tr>
				<td>井队编号</td>
				<td>
					<input type="text" name="tname" class='write' style='width:150px;height:30px;' value='<?php echo $this->scope["data"]["tname"];?>'/>
			...
			<tr>
				<td>添加时间</td>
				<td>
					<input type="text" name='time' style='width:150px;text-align:center;height:30px;'value="<?php echo date('Y-m-d H:i:s') ?>"/>
				</td>
			</tr>	
			<tr>
				<td><input type="submit" class='btn' value='确定更新'/></td>
