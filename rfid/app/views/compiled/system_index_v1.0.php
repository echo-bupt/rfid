...
<div id="content" style="text-align:center;">
	<a class="btn-small-f btn-mini btn-info" style="float:right;" href="/system/add">+</a>
...
?>
					<tr>
						...
						<td>
							<?php echo $this->scope["child"]["role"];?>

						</td>
					<td>
					<a class='btn btn-small-f edit' href="/system/edit/sid/<?php echo $this->scope["child"]["sid"];?>">编辑</a>
					<a class='btn btn-small-f del'  href="/system/delete/sid/<?php echo $this->scope["child"]["sid"];?>">删除</a>
					</td>
					</tr>
				<?php 
/* -- foreach end output */
...
?>
			<h2>暂时没有任何管理员，请点击<a href="/system/add">添加管理员</a></h2>
			<?php 
}?>
