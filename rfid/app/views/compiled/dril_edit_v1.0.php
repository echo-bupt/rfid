...
<body>
<div id="content">
	<form id="tool" action="/dril/edit" method="post">
...
?>
					<input type='hidden' name='did' value='<?php echo $this->scope["data"]["did"];?>'/>
...
?>
					<input id="d11" type="text" style="height:30px;" name="<?php echo $this->scope["v"]["pname"];?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<?php echo $this->readVar("data.".(isset($this->scope["v"]["pname"]) ? $this->scope["v"]["pname"]:null));?>' class='write'/>
...
?>
					<input type="text" name="<?php echo $this->scope["v"]["pname"];?>" class='dril write' value='<?php echo $this->readVar("data.".(isset($this->scope["v"]["pname"]) ? $this->scope["v"]["pname"]:null));?>'<?php if ((isset($this->scope["v"]["pname"]) ? $this->scope["v"]["pname"]:null) == 'epc') {
?>id="epc" value=" "<?php 
