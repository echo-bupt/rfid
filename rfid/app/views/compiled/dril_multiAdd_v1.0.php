...
<body>
<div id="content">
	<form id="tool" action="/dril/multi" method="post">
...
?>
					<input type="text" name="<?php echo $this->scope["v"]["pname"];?>" class='dril' value='<?php echo $this->readVar("data.".(isset($this->scope["v"]["pname"]) ? $this->scope["v"]["pname"]:null));?>'<?php if ((isset($this->scope["v"]["pname"]) ? $this->scope["v"]["pname"]:null) == 'epc') {
?>id="epc" value=" "<?php 
...
?>
					设备个数(同种设备):<input type='text' id="num" style='width:10%;height:30px;' />
					<input type='button' id='multi' value="扫描" class='green' style="width:10%;height:38px;float:right;margin-right:5px;margin-top:0px;"/>
					<?php 
}?>
