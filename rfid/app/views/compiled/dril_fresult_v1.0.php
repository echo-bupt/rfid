...
<div id="map" style='vertical-align:center;'>
	...
	<a class='btn btn-small-f edit' href='/dril/exportFindPage/page/<?php echo $this->scope["pagenum"];?>' style='float:right;margin-top:10px;'>导出本页钻具数据</a>
...
?>
			<h2>暂时没有任何符合条件的钻具，请点击<a href="/dril/findDisplay">重新查询</a>或者<a href='/dril/index'>返回库存</a></h2>
			<?php 
}?>
