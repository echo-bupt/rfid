...
<body>
<div id="map">
	<span class='title'>钻具属性</span>
</div>
<div id="content" style="text-align:center;">
	<a class="btn-small-f btn-mini btn-info" style="float:right;" href="/property/add">+</a>
...
?>
				<tr>
					<td><?php echo $this->scope["child"]["pname"];?></td>
					<td><?php echo $this->scope["child"]["nickname"];?></td>
					<td><?php echo date("Y-m-d H:i:s", (isset($this->scope["child"]["time"]) ? $this->scope["child"]["time"]:null));?></td>
					<?php if($_SESSION['super']==1){?>
					<td>
						<a class='btn btn-small-f edit' href="/property/edit/pid/<?php echo $this->scope["child"]["pid"];?>">编辑</a>
						<a class='btn btn-small-f del'  href="/property/delete/pid/<?php echo $this->scope["child"]["pid"];?>">删除</a>
					</td>
					<?php }?>
				</tr>
			<?php 
